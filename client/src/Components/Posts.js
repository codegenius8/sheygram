...
const Posts = ({ post,postInProfilePage }) => {
  ...
  const { likeorunlikeloading } = useSelector((state) => state.alertsReducers);
  ...
  return (
    <div className="bs1 p-2 mt-3">
      <div className="d-flex justify-content-between align-items-center bs-1">
        <div className="d-flex align-items-center">
          {post.user.profilepicUrl === "" ? (
            ...
            <img src={post.user.profilepicUrl} alt="" height="35" width="35" style={{ borderRadius :  "50%" }}/>
          )}
      ...
      <img src={post.image} alt="" className="postimage w-100" style={{ height : postInProfilePage == true && '200px' ,borderRadius :  "2%" }}/>
